/*	@(#)str_io.c 1.1 94/10/31 SMI; from S5R3.1 os/streamio.c 10.17.3.4	*/
	...
	int flag;
{
	...
	case I_NREAD: {
		...
		/*
		 * protect reading from the queue since other hi pri
		 * code may free the buffer and bomb out msgdsize!!!
		 * bug 1054721
		 */
		s = splstr();
